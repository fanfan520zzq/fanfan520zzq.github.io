...
export const siteConfig: SiteConfig = {
	...
	navbarTitle: {
		...
		// 网站Logo图片路径
		logo: "assets/home/round-logo.png",
	},

	bangumi: {
		userId: "Rou_Guang", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/oso.webp",
				"/assets/desktop-banner/lufi.webp",
				"/assets/desktop-banner/jingliu.webp",
				"/assets/desktop-banner/saino.webp",
				"/assets/desktop-banner/moganna.webp",
				"/assets/desktop-banner/elden.webp",
			], // 桌面横幅图片
			mobile: [
				"/assets/desktop-banner/oso.webp",
				"/assets/desktop-banner/lufi.webp",
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/fanfan520zzq",
					external: true,
				...
				{
					name: "Gitee",
					url: "https://gitee.com/FANFAN520ZZQ",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/raze.webp", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Yifan Yang",
	bio: "矫枉必须过正，不过正不能矫枉",
	typewriter: {
	...
	links: [
		{
			name: "Bilibili",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/333664452",
		},
		{
			name: "Gitee",
			icon: "mdi:git",
		...
		},
		{
			...
			url: "https://codeberg.org/RouGuang",
		},
		{
			name: "Discord",
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://metingapi.nanorocky.top/api?server=:server&type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址
	id: "17691493012", // 歌单ID
